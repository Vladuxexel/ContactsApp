...
namespace ContactsApp.UnitTests
{
    ...
    public class ContactTests
    {
        ...
        [Test]
        public void Clone_GoodClone_IsEqual()
        {
            //Setup
            _contact.Surname = "Sidorov";
            _contact.Name = "Petr";
            _contact.BirthDate = new DateTime(1999, 10, 12);
            _contact.PhoneNumber = new PhoneNumber() { Number = 72322334421 };
            _contact.Email = "sidpetr@gmail.com";
            _contact.VkId = "id/1231232";

            //Act
            var actualContact = _contact.Clone() as Contact;

            //Assert
            Assert.AreEqual(actualContact, _contact);
        }

        [Test]
        public void Clone_BadClone()
        {
